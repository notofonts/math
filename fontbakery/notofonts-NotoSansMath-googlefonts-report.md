...
<p>Width = 699:
notelement, propersuperset, uni2AC8, uni2288, uni27C4, uni228A, uni22F5, uni2ABD, reflexsuperset, uni22FB, uni2285, propersubset, uni220C, uni22F6, suchthat, uni22F8, uni27C3, uni2AC7, uni228B, notsubset, uni297F, uni22F9, uni2ABE, reflexsubset, uni22D0, uni2289, uni22FD, uni22F3, uni297E, element, uni22D1</p>
<p>Width = 540:
proportional</p>
<p>Width = 652:
uni299C, uni299F, uni29A9, uni299E, uni2221, uni299D, uni29A4, uni27D4, uni299B, uni27C0, uni29A2, orthogonal, uni29A3, uni27D3, uni29AA, uni22BE, uni29A8, uni29AB, uni29A5, angle</p>
<p>Width = 617:
uni2A27, uni2239</p>
<p>Width = 696:
uni223E</p>
...
uni223F, uni2A33</p>
<p>Width = 573:
uni2A88, uni2AF3, uni2271, uni2A7C, greaterequal, uni2A7B, approxequal, lessequal, uni2270</p>
<p>Width = 542:
uni227B, uni22E0, uni2281, uni22DE, uni22DF, uni22E1, uni2280, uni227C, uni227D, uni227A</p>
<p>Width = 756:
uni2AE9, uni2AE8, uni2AEA, uni3012, uni22A3, uni22A8, uni22A5, uni2AEB, uni22A2, uni2AE0, uni2AE4, uni2AE2, uni2AE7, uni22A4, uni2ADF</p>
<p>Width = 567:
uni22B1, uni22B0</p>
<p>Width = 532:
uni22D6, uni22D7</p>
...
<p>Width = 681:
smallerthan, uni2AAC, uni2AAD, uni2AAB</p>
<p>Width = 679:
uni2ACB, uni2ACF, uni2AD6, uni2AD5, uni2ACA, uni2AC0, uni2AC9, uni2AC5, uni2AD2, uni2AC1, uni2AC3, uni2AC4, uni2ABF, uni2AC6, uni2AD3, uni2AD4, uni2ACC, uni2AD1, uni2AC2, uni2AD0</p>
<p>Width = 754:
uni2AE1</p>
<p>Width = 836:
uni2AE6</p>
...
<li>U+0331 COMBINING MACRON BELOW: try adding one of: thai, tifinagh, cherokee, sunuwar, gothic, syriac, caucasian-albanian</li>
...
<li>U+060C ARABIC COMMA: try adding one of: hanifi-rohingya, arabic, yezidi, syriac, garay, thaana, nko</li>
...
<li>U+0660 ARABIC-INDIC DIGIT ZERO: try adding one of: hanifi-rohingya, arabic, yezidi, indic-siyaq-numbers, syriac, thaana</li>
...
<li>U+2010 HYPHEN: try adding one of: kaithi, arabic, sora-sompeng, kharoshthi, yi, kayah-li, sundanese, armenian, coptic, lisu, syloti-nagri, hebrew, cham</li>
...
<li>U+3012 POSTAL MARK: try adding one of: chinese-traditional, phags-pa, chinese-simplified, yi, chinese-hongkong, japanese</li>
...
<p>Your font fully covers the following languages that require the soft-dotted feature: Ekpeye (Latn, 226,000 speakers), Abua (Latn, 25,000 speakers), Dutch (Latn, 31,709,104 speakers), Ebira (Latn, 2,200,000 speakers), Ikwere (Latn, 717,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Igbo (Latn, 27,823,640 speakers).</p>
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Bete-Bendi (Latn, 100,000 speakers), Kaska (Latn, 125 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Bafut (Latn, 158,146 speakers), Basaa (Latn, 332,940 speakers), Southern Tutchone (Latn, 65 speakers), Aghem (Latn, 38,843 speakers), Northern Tutchone (Latn, 85 speakers), Mfumte (Latn, 79,000 speakers), Dii (Latn, 71,000 speakers), Han (Latn, 6 speakers), Vute (Latn, 21,000 speakers), Gulay (Latn, 250,478 speakers), Keliko (Latn, 63,000 speakers), Kom (Latn, 360,685 speakers), Ejagham (Latn, 120,000 speakers), Zapotec (Latn, 490,000 speakers), Nateni (Latn, 100,000 speakers), Mango (Latn, 77,000 speakers), Cicipu (Latn, 44,000 speakers), Koonzime (Latn, 40,000 speakers), Nzakara (Latn, 50,000 speakers), Makaa (Latn, 221,000 speakers), Southern Kisi (Latn, 360,000 speakers), Avokaya (Latn, 100,000 speakers), Yala (Latn, 200,000 speakers), Teke-Ebo (Latn, 260,000 speakers), Ma’di (Latn, 584,000 speakers), Lugbara (Latn, 2,200,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), South Central Banda (Latn, 244,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Sar (Latn, 500,000 speakers), Dan (Latn, 1,099,244 speakers), Longto (Latn, 5,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Western Krahn (Latn, 97,800 speakers), Heiltsuk (Latn, 300 speakers), Lithuanian (Latn, 2,357,094 speakers), Navajo (Latn, 166,319 speakers), Fur (Latn, 1,230,163 speakers), Mundani (Latn, 34,000 speakers).</p>
 [code: soft-dotted]
